...
<div>
    <div class="form-group">
        ...
        <div id="map2" style="height: 300px; z-index: 1"></div>
        <div class="row">
            <div class="col-6">
...
@push('script')
<script>
    var map{{ $identifier }} = L.map('map2').setView([{{ $lat }}, {{ $lng }}], 15).on('click', onClick{{ $identifier }}Maps).on('moveend', onMove{{ $identifier }}Maps)
